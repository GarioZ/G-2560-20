...
Level.prototype.create = function() {
	...
	this.map = this.game.add.tilemap("real_level_1");
	this.map.addTilesetImage('tile_set');
	this.maplayer4 = this.map.createLayer("Tile Layer 4");
	this.maplayer5 = this.map.createLayer("Tile Layer 5");
	...
	this.map.setCollisionBetween(0,9999,true,this.maplayer5);
...
Level.prototype.collectCap  = function (player, cap) {
...
Level.prototype.addKabduk1 = function(x, y) {
...
Level.prototype.addKabduk2 = function(x, y) {
...
Level.prototype.addKabduk3 = function(x, y) {
	c = this.add.sprite(x, y, "Kabduk3");
	c.anchor.set(0,0.9);
	c.smoothed = false;
	this.game.physics.enable(c);
	return c;
...
Level.prototype.addKabduk4 = function(x, y) {
...
Level.prototype.addKabduk5 = function(x, y) {
	c = this.add.sprite(x, y, "Kabduk5");
	c.anchor.set(0,0.9);
	c.smoothed = false;
	this.game.physics.enable(c);
	return c;
